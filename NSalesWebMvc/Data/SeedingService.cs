...
using NSalesWebMvc.Models.Enums;

namespace NSalesWebMvc.Data
{
    public class SeedingService
    {
        private NSalesWebMvcContext _context;

        public SeedingService(NSalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            //Tests if the DB has been seeded (populado)
